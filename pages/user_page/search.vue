<template>
  <div>
    <client-only>
      ...
      <div id="container"> 
        <div id="page_title">
          <h1><i class="fas fa-paw icon" style="color:#ff7d6e;"></i>検索</h1>
        </div>
        ...
        <div class="register_btn">
          <a href="/list/search/" class="btn btn-radius-solid" style="font-weight: bold;">検索</a>  
        </div>
      </div>
      <Footer />
      <Copylight />
